...
public class SecurityConfig {
    ...
    // ВАЖНО: Создаем фильтр CORS с максимально возможным приоритетом.
    // Это гарантирует добавление заголовков даже если запрос завершился ошибкой 401/500.
    @Bean
    @Order(Ordered.HIGHEST_PRECEDENCE)
    public CorsFilter corsFilter() {
        CorsConfiguration configuration = new CorsConfiguration();
        // Используем AllowedOriginPatterns для гибкости с доменами sslip.io
