        ...
        <div class="info-side">
            ...
            {#if appointment.clientPhone}
                <div class="data-item phone-row">
                    ...
                    <a href="tg://resolve?phone={appointment.clientPhone.replace(/\D/g, '')}" class="btn-tg" title="Написать в Telegram" target="_blank">
...
<style>
    ...
    .btn-tg { text-decoration: none; display: inline-flex; align-items: center; opacity: 0.7; margin-left: 8px; transition: opacity 0.2s; }
