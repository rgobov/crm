...
<style>
    ...
    .phone-link { color: #2563eb !important; text-decoration: none; font-size: 16px !important; }
    .btn-call-action { background: #3b82f6; color: white; padding: 5px 10px; border-radius: 8px; font-size: 9px; font-weight: 900; text-decoration: none; }
    .call-action { display: flex; align-items: center; gap: 6px; }
    .btn-tg-action { background: #0088cc; color: white; padding: 5px 8px; border-radius: 8px; font-size: 9px; font-weight: 900; text-decoration: none; display: inline-flex; align-items: center; gap: 3px; }
