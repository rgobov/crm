...
<style>
    .shell { display: flex; flex-direction: column; min-height: 100vh; background-color: var(--bg-color); }
    .header { display: flex; justify-content: space-between; align-items: center; padding: 20px; background: white; border-bottom: 1px solid rgba(0,0,0,0.03); }
    .user-info { display: flex; align-items: center; gap: 12px; }
    .avatar { width: 40px; height: 44px; background: var(--primary-gradient); color: white; border-radius: 12px; display: flex; justify-content: center; align-items: center; font-weight: 800; }
    h2 { font-size: 16px; margin: 0; color: #0f172a; }
    .text p { margin: 0; font-size: 12px; color: var(--hint-color); }
    .logout-btn { background: #f1f5f9; color: #64748b; border: none; padding: 8px 12px; border-radius: 10px; font-size: 12px; font-weight: 600; }
